...
export default function App() {
  ...
  const videos = [
    { title: "AI Services Overview", src: "/videos/ai-services.mp4" },
    { title: "Digital Ad Services", src: "/videos/digital-Ad-services-1.mp4" },
    { title: "Advanced AI Solutions", src: "/videos/digital-AI-services-2.mp4" },
  ];
        ...
        <section id="services" className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid lg:grid-cols-3 gap-10">
              {[
                { title: "AI & Deep Learning", icon: Brain, image: "/images/AI-Consulting.jpeg", alt: "AI Consulting" },
                { title: "IoT & Edge Computing", icon: Zap, image: "/images/IOT-EdgeComputing.png", alt: "IoT Edge Computing" },
                { title: "Fintech & Enterprise IT", icon: Cloud, image: "/images/Fintech.png", alt: "Fintech Solutions" },
              ].map((card) => (
                <motion.div key={card.title} variants={item} whileHover={{ y: -15, shadow: "0 25px 50px -12px rgba(0,0,0,0.15)" }} className="group relative overflow-hidden rounded-3xl bg-white shadow-xl border border-purple-100">
                  <Image src={card.image} alt={card.alt} width={800} height={600} className="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-700" />
                  <div className="p-8">
